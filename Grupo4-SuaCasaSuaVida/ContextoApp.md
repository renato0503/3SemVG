# Contexto do App — SuaCasaSuaVida

**Grupo 4 — SuaCasaSuaVida** · Prof. Pantaleão · Integrantes: Amanda Karoliny, Beatriz Cristina, Evander, Julimary.
...
**Persona 1 — Dona Rosa, 47 anos, auxiliar de serviços gerais (Várzea Grande–MT)**
Paga aluguel há 12 anos e sonha em ter uma casa própria para parar de "pagar a casa dos outros". Não tem reserva e nunca entendeu um contrato de financiamento. Dor: sente que juntar a entrada é impossível e tem medo de assinar algo que não consiga pagar. O que ela quer: descobrir, sem julgamento, **quanto precisaria guardar e quanto pagaria por mês**.

**Persona 2 — Evandro, 33 anos, técnico de manutenção, casado com um filho**
Mora com a família num apartamento alugado e quer se mudar para uma casa em bairro com escola e segurança. Compara bairros pelo boca a boca e pela distância do trabalho. Dor: já visitou imóveis em regiões que pareciam boas de dia e não pareciam de noite, e perdeu tempo com opções fora do orçamento. O que ele quer: **filtrar bairros** por segurança, serviços e valorização, e saber o que cabe na renda.
...
| Bloco | Conteúdo |
| --- | --- |
| **Tarefa do usuário** | Decidir se, quando e onde comprar a casa própria com segurança. |
| **Dores** | Insegurança sobre o bairro, medo do financiamento, dificuldade de juntar a entrada, informação espalhada e enviesada, medo de assumir dívida longa. |
| **Ganhos esperados** | Clareza sobre o bairro, noção realista do quanto pode pagar, plano para a entrada, comparação entre opções, decisão com mais confiança. |
| **Solução** | Análise de bairro + análise da situação financeira + simulação de parcela + organização do plano de compra. |
| **Canais** | App/site responsivo; link compartilhável; opção de apoio presencial em posto de atendimento. |
...
**Explorar bairros.** Com uma faixa de preço em mãos, o usuário compara bairros por **segurança, serviços (escola, saúde, mercado), transporte e potencial de valorização**. Vê o que moradores e dados públicos dizem, com o cuidado de sinalizar o que é dado objetivo e o que é percepção.
...
| --- | --- | --- | --- |
| Análise financeira básica | Faixa de parcela a partir de percepções | Simulação com receitas e despesas | Plano de poupança personalizado |
| Análise de bairro | Ficha simples (serviços, transporte, segurança percebida) | Comparador entre bairros | Índice de valorização e tendência |
| Simulação de financiamento | Parcela e prazo em faixas | Cenários comparáveis e juros editáveis | Integração com condições indicativas de instituições |
| Comparação de imóveis | Lista salva manualmente | Comparador por critérios | Recomendações com base no perfil |
| Educação financeira | Dicas curtas e glossário | Trilhas de aprendizado | Metas e acompanhamento da reserva |
| Canal | Web responsiva + link | App dedicado | App + apoio presencial/parceria |
...
| --- | --- | --- |
| Portais de imóveis | Foco em vender; bairro aparece só como endereço | Análise do bairro na perspectiva de quem vai morar |
| Corretor | Interesse na venda; olhar de vendedor | Olhar de comprador, sem pressa de fechar |
| Banco/financeira | Mostra o crédito, não a realidade do orçamento | Analisa o bolso antes de propor a parcela |
| Grupos de WhatsApp de bairro | Relatos dispersos e informais | Informação organizada e comparável |
...
**Dados usados.** A base combina três fontes: (1) dados públicos de infraestrutura e serviços por bairro; (2) informações informadas pelo próprio usuário sobre sua situação; e (3) contribuições agregadas da comunidade (percepção de segurança, rotina do bairro), sempre voluntárias.

**Princípios de LGPD adotados.**

- **Minimização:** pedir o essencial e **nunca** exigir valores exatos de renda, patrimônio ou dívidas — só faixas e percepções.
- **Finalidade explícita:** os dados servem apenas para orientar o planejamento da compra; nada de venda a terceiros.
- **Anonimização/agregação:** indicadores de bairro são publicados de forma agregada; nenhum relato individual identifica o morador.
- **Consentimento e transparência:** o usuário sabe o que é dado objetivo e o que é percepção, e pode retirar o consentimento.
- **Segurança:** dados financeiros informados ficam protegidos e são tratados como sensíveis; acesso restrito.
- **Direitos do titular:** consulta, correção e exclusão a qualquer momento.
...
- parceria com programas de habitação e cooperativas;
- versão institucional para prefeituras e entidades de apoio ao morador;
- apoio a editais de inovação e extensão universitária;
...
| KPI | O que mede |
| --- | --- |
| Usuários que concluem a análise financeira | Utilidade da proposta inicial |
| Usuários que comparam dois ou mais bairros | Valor da análise de bairro |
| Simulações de financiamento realizadas | Engajamento com a decisão |
| Tempo médio de decisão (do sonho à escolha) | Redução de indecisão |
| % que relatam maior clareza após usar | Percepção de valor |
| Metas de entrada criadas e acompanhadas | Comportamento de planejamento |
...
| --- | --- | --- |
| Análise de bairro imprecisa ou enviesada | Alto | Separar dado objetivo de percepção; usar fontes públicas e agregação |
| Simulação de financiamento irreal | Alto | Exibir faixas, com aviso de que não é proposta oficial |
| Usuário informar dados errados | Médio | Perguntas simples de percepção; revisão guiada |
| Expectativa de que o app "resolve" a compra | Médio | Posicionar como apoio/educação, não como corretora |
| Uso indevido de dado financeiro sensível | Alto | LGPD desde o MVP: minimização, agregação, consentimento |
...
| 2 | Código + planilha | Geração do código `G4-<nnn>` e integração com a planilha de respostas |
...
- **Não há respostas abertas** no formulário. **Nunca** se pergunta renda ou patrimônio em valores.
- **Falas do entrevistado:** vão para um **áudio no WhatsApp que começa com o código `G4-<nnn>`**, ligando a narrativa à resposta registrada.
...
"Você paga aluguel e sonha com a casa própria, mas não sabe se o bairro é bom, se o imóvel vai valorizar nem se a parcela cabe no seu bolso. O SuaCasaSuaVida junta as duas respostas num só lugar: analisa o bairro — segurança, serviços, valorização — e analisa a sua situação financeira para mostrar quanto você realmente consegue pagar e como chegar até a entrada. Sem vender imóvel, sem vender crédito: só informação para você comprar com segurança. Decida no seu tempo, mas nunca mais no escuro."
