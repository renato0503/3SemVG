# Contexto do App — Dinheiro na Mão

**Grupo 1 — Dinheiro na Mão** · Profa. Olivia · Integrantes: Giselle, Evelin, Franciely, Mara Fernanda.
...
- contas que se acumulam e vencem em datas diferentes sem um calendário único;
- esquecimento de vencimentos, gerando juros e negativação;
- compras por impulso que consomem o pouco que sobra;
...
**Persona 1 — Dona Zilda, 54 anos, diarista (Várzea Grande–MT)**
Cuida das contas da casa sozinha, com renda que varia a cada mês. Usa WhatsApp todos os dias, mas não confia em aplicativo de banco nem em "consultoria". Dor: perde datas de vencimento e só percebe quando chega a cobrança com juros. O que ela quer: alguém que a ajude, **pessoalmente**, a montar um calendário simples e a não esquecer mais as datas.

**Persona 2 — Jonas, 33 anos, motorista de aplicativo**
Renda irregular e muitas contas pequenas espalhadas. Já tentou planilha no celular, mas abandonou em duas semanas. Decide compras por impulso quando o caixa está cheio, e aperta o cinto quando o mês é fraco. Dor: não sabe quanto realmente sobra e nunca consegue formar reserva. O que ele quer: um sistema que **junte contas e datas** e o lembre antes de assumir algo novo.
...
| Bloco | Conteúdo |
| --- | --- |
| **Tarefa do usuário** | Organizar contas e datas, reduzir atrasos e recuperar o controle do orçamento familiar. |
| **Dores** | Desorganização, esquecimento de vencimentos, juros, compras por impulso, vergonha de pedir ajuda, desconfiança. |
| **Ganhos esperados** | Calendário único de contas, lembretes de vencimento, clareza sobre o que sobra, apoio humano e reconhecimento pelo esforço. |
| **Solução** | Atendimento presencial com profissional + sistema inteligente de contas e datas + bolsa-incentivo. |
| **Canais** | Posto de atendimento presencial (principal), apoio pelo WhatsApp e sistema web/app de organização. |
...
**Atendimento presencial.** No posto, um profissional conversa com a pessoa sobre como o dinheiro entra e sai da casa, lista as contas e as datas de vencimento e monta, junto com ela, um **calendário único** de pagamentos. Nada de valores de dívida expostos ou cobrança — o foco é **método**.

**Sistema inteligente.** As contas e datas são registradas no sistema, que passa a **lembrar a pessoa antes de cada vencimento** e a mostrar quanto sobra depois de pagar tudo. Com o tempo, o sistema ajuda a identificar excessos e a sugerir ajustes.
...
| --- | --- | --- | --- |
| Atendimento presencial | Piloto em um posto, com profissional | Mais postos e horários ampliados | Rede integrada com CRAS e agências |
| Cadastro de contas e datas | Manual, com o profissional no balcão | Autoatendimento assistido | Importação e categorização automática |
| Lembretes de vencimento | Por WhatsApp | Por WhatsApp com confirmação | Canal preferido pelo usuário (SMS, ligação, app) |
| Calendário de contas | Calendário simples | Calendário com prioridade de pagamento | Sugestão inteligente de melhor ordem de pagamento |
| Visão de sobra do mês | Não | Resumo do que sobra | Projeção de meses futuros |
...
| --- | --- | --- |
| Fazer "de cabeça" | Não há registro nem lembrete; datas são esquecidas | Método simples e calendário único com apoio profissional |
| Caderno de contas | Trabalhoso, fácil de perder, sem lembrete | Sistema com lembretes e visão da sobra do mês |
| Planilha no celular | Exige constância e letramento digital; costuma ser abandonada | Atendimento humano no balcão + acompanhamento |
| Consultoria financeira paga | Custo alto e percepção de "coisa de rico" | Público, gratuita e sem julgamento |
...
**Integração com o poder público.** O programa nasce dentro ou em parceria com a esfera pública (município, estado ou união). A base inicial usa dados de programas sociais já existentes apenas para **elegibilidade**, nunca para exposição pública. O sistema de contas e datas é preenchido com informação **fornecida pela própria família**.

**LGPD.** Princípios adotados:

- **Minimização:** coletar apenas o necessário para organizar contas e datas — sem valores de renda detalhados nem valores de dívida.
- **Finalidade explícita:** os dados servem exclusivamente ao atendimento e ao acompanhamento da própria família. Nada de uso comercial.
- **Segurança:** dados financeiros e de programas sociais nunca em texto livre nem expostos no balcão; acesso restrito ao profissional responsável.
- **Consentimento e transparência:** a pessoa entende o que é registrado, por quê e como retirar o consentimento.
- **Direitos do titular:** consulta, correção e exclusão dos dados a qualquer momento.
- **Vulnerabilidade:** o público é sensível; o programa trata a informação com cuidado e sem qualquer forma de constrangimento.
...
- política pública com orçamento próprio, por se tratar de proteção ao consumidor e educação financeira;
- parceria com CRAS, agências e consórcios municipais para uso dos postos e do sistema;
- custo por família baixo (atendimento pontual + tecnologia simples), o que favorece escala;
...
| KPI | O que mede |
| --- | --- |
| Nº de famílias atendidas no piloto | Alcance do programa |
| % de famílias que montaram o calendário de contas | Eficácia da etapa presencial |
| Redução de contas pagas com atraso/juros | Impacto direto na dor principal |
| % de lembretes de vencimento seguidos | Utilidade do sistema inteligente |
| Frequência de retorno ao posto | Acompanhamento e vínculo |
| % de famílias que mantiveram o benefício no ciclo | Adesão à bolsa-incentivo |
| Percepção de controle do orçamento | Benefício percebido |
...
| --- | --- | --- |
| Vergonha/constrangimento ao falar de dívida | Alto | Atendimento acolhedor, sem julgamento, em local reservado |
| Bolsa-incentivo virar dependência ou distorção | Alto | Regras claras, ciclos definidos, foco na organização e não na renda |
| Sistema complexo para o público | Médio | Interface simples, cadastro assistido pelo profissional |
| Baixa adesão inicial | Médio | Divulgação via postos, CRAS e agentes de confiança |
| Exposição indevida de dados | Alto | LGPD desde o MVP: minimização, segurança, consentimento |
...
| 2 | Código + planilha | Geração do código `G1-<nnn>` e integração com a planilha de respostas |
...
- **Falas da pessoa:** vão para um **áudio no WhatsApp que começa com o código `G1-<nnn>`**, ligando a narrativa à resposta registrada.
...
"Você já pagou juros porque esqueceu uma data? O Dinheiro na Mão resolve isso. É um programa público com atendimento presencial: uma pessoa de verdade te ajuda a juntar as contas e montar um calendário único, um sistema inteligente te lembra dos vencimentos, e quem organiza a vida financeira recebe uma bolsa-incentivo como empurrão. Sem julgamento, sem emprestar dinheiro e sem pedir valor de renda. Menos juros, mais controle e uma família no comando do próprio orçamento."
